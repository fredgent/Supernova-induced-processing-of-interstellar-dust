...
\section{Dust processing}
 ...
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C1/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C1/Density_1_02000.pdf}\\
 ...
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C1/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C1/Density_1_02000.pdf}\\
 ...
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C1/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C1/Density_1_02000.pdf}\\
 ...
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C1/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C1/Density_1_02000.pdf}\\
  ...
  \end{figure*}  
    ...
    \begin{figure*}
 \includegraphics[trim=2.8cm 1.5cm 9.3cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C2/Density_1_00041.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C2/Density_1_00201.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C2/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=1,height = 4.5cm]{Pics/Pics_C2/Density_1_02000.pdf}\\
  \includegraphics[trim=2.8cm 1.5cm 9.3cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C2/Density_1_00041.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C2/Density_1_00201.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C2/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=2,height = 4.5cm]{Pics/Pics_C2/Density_1_02000.pdf}\\
  \includegraphics[trim=2.8cm 1.5cm 9.3cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C2/Density_1_00041.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C2/Density_1_00201.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C2/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=3,height = 4.5cm]{Pics/Pics_C2/Density_1_02000.pdf}\\
  \includegraphics[trim=2.8cm 1.5cm 9.3cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C2/Density_1_00041.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C2/Density_1_00201.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 9.3cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C2/Density_1_00501.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=5.2cm 1.5cm 3.2cm 2.0cm, clip=true,page=4,height = 4.5cm]{Pics/Pics_C2/Density_1_02000.pdf}\\
  \caption{Temporal evolution of the spatial dust density for \textbf{Simulation C-2} ($n_\text{gas}=0.1\,\text{cm}^{-3}$, turbulence, transport + sputtering + grain-grain collisions). The first, second, third, and fourth rows show the distribution of 0.6, 3.7, 32.7, 201.7$\,$nm grains, respectively. The colourscale is fixed for each row.}
   \label{fig_C2} 
  \end{figure*}  
  
      \begin{figure*}
 \includegraphics[trim=2.5cm 1.5cm 2.2cm 2.3cm, clip=true,page=1,height = 6cm]{Pics/Pics_C2/Evolution_total.pdf}\hspace*{-0.1cm}
 \includegraphics[trim=2.4cm 1.5cm 2.2cm 2.3cm, clip=true,page=1,height = 6cm]{Pics/Pics_C2/Particlenumbers_02000.pdf}\\
